...
The first version explores this through a neural functional representation followed by sparse equation recovery using techniques such as LASSO/SINDy. The current implementation, experiments, ablations, and results are available in the Neural-Symbollic-Regression-v1-main directory.
